"""
# TODO: Atividade 34:  Raspagem de dados Web e construção de relatórios.
...
class TestIBGE:
    ...
    def test_exite_path(self) -> None:
        assert path.exists(), f'Ops: {path} não existe.'

    def test_exite_dir(self) -> None:
    ...
    def test_content_json(self) -> None:
        s = (
            'W3siRVNUQURPIjogIkFjcmUiLCAiU0lHTEEiOiAiQUMiLCAiQ0FQSVRBTCI6ICJSaW8gQnJhbmNvIiwgIkdFTlRJTElDTyI6ICJ'
